...
export const pageSEO: Record<string, SEOMetadata> = {
  ...
  services: {
    title: 'Artificial Turf Services | Cleaning, Sanitization & Putting Green Refresh | Denver',
    description:
      'Professional turf cleaning, sanitization, odor treatment, fiber restoration, and putting green performance tuning. Serving the Denver metro area.',
    keywords: [
      'turf cleaning services Denver',
  ...
  locations: {
    ...
    keywords: [
      ...
      'Douglas County turf cleaning',
      'Arapahoe County turf care',
      'Jefferson County artificial turf',
    ],
  },
  blog: {
